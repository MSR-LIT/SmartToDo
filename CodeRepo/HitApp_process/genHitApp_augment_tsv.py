...
if __name__=='__main__':
    ...
    path_to_augment_json = '../data/augment_data/Augment_dataset.json'
    ...
    # The points below are discarded due to Hexadecimal character encoding issues.
    exclude_email_list = ['049-001013-EM', '057-008092-EM', '277-012402-EM', '277-006074-EM', '279-012806-EM']

    with open(path_to_augment_json, encoding='utf-8') as json_data:
        ...
        path_to_hitapp_task = 'Augment_batch_start_{}_size_{}.tsv'.format(start_index, max_points)

        with open(path_to_hitapp_task, 'w', encoding='utf-8-sig') as f_out:
            ...
            for i in range(start_index, end_index):
                ...
                if data[i]['current_id'] in exclude_email_list:
                    continue
