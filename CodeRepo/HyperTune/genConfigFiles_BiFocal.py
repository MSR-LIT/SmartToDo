    ...
    for embed_dim in embed_dim_list:
        for i in range(len(option_list)):
            for tokenizer in tokenizer_list:
                ...
                with open('../data/BiFocal_config_final/{}/config-{}.yml'.format(tokenizer, index), 'w') as fptr:
                    ...
                    save_model = 'checkpoints_BiFocal_final/avocado.{}_tokenized/{}/model'.format(tokenizer, index)
                    pre_word_vecs_enc = 'processed_final/avocado.{}_tokenized.{}.copy.embeddings.d{}.enc.pt'\
                        .format(tokenizer, vocab_type, embed_dim)
                    pre_word_vecs_match = 'processed_final/avocado.{}_tokenized.{}.copy.embeddings.d{}.match.pt' \
                        .format(tokenizer, vocab_type, embed_dim)
