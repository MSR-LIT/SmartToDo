...
if __name__=='__main__':
    ...
    src_out_name = '../data/Orig_seq2seq_final_data/avocado.{}_tokenized/src-all.txt'.format(token_type)
    tokenized_tgt_out_name = '../data/Orig_seq2seq_final_data/avocado.{}_tokenized/tgt-all.txt'.format(token_type)
    gold_tgt_out_name = '../data/Gold_seq2seq_final_data/gold-tgt-all.txt'.format(token_type)
