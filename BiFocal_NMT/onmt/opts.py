...
def model_opts(parser):
    ...
    group.add('--qry_word_vec_size', '-qry_word_vec_size',
              type=int, default=500,
              help='Word embedding size for qry.')
    ...
    group.add('--feat_merge', '-feat_merge', type=str, default='sum',
    ...
    group.add('--matcher_type', '-matcher_type', type=str, default='rnn',
              choices=['rnn', 'brnn', 'mean', 'transformer', 'cnn'],
              help="Type of matcher layer to use. Non-RNN layers "
                   "are experimental. Options are "
                   "[rnn|brnn|mean|transformer|cnn].")
    ...
    group.add('--match_layers', '-match_layers', type=int, default=1,
              help='Number of layers in the matcher')
    ...
    group.add('--enc_rnn_size', '-enc_rnn_size', type=int, default=500,
              help="Size of encoder rnn hidden states. "
                   ...
                   "speech-to-text.")
    group.add('--match_rnn_size', '-match_rnn_size', type=int, default=500,
              help="Size of matcher rnn hidden states. "
...
def preprocess_opts(parser):
    ...
    group.add('--train_qry', '-train_qry', required=True, nargs='+',
              help="Path(s) to the training query data")
    ...
    group.add('--valid_qry', '-valid_qry',
              help="Path to the validation query data")
    ...
    group.add('--src_vocab', '-src_vocab', default="",
              help="Path to an existing source vocabulary. Format: "
                   "one word per line.")
    group.add('--qry_vocab', '-qry_vocab', default="",
              help="Path to an existing query vocabulary. Format: "
                   "one word per line.")
    ...
    group.add('--qry_vocab_size', '-qry_vocab_size', type=int, default=50000,
              help="Size of the query vocabulary")
    ...
    group.add('--qry_words_min_frequency',
              '-qry_words_min_frequency', type=int, default=0)
    ...
    group.add('--qry_seq_length', '-qry_seq_length', type=int, default=512,
              help="Maximum query sequence length")
    group.add('--qry_seq_length_trunc', '-qry_seq_length_trunc',
              type=int, default=None,
              help="Truncate query sequence length.")
...
def train_opts(parser):
    ...
    group.add('--pre_word_vecs_match', '-pre_word_vecs_match',
              help="If a valid path is specified, then this will load "
                   "pretrained word embeddings on the matcher side. "
                   "See README for specific formatting instructions.")
    ...
    group.add('--fix_word_vecs_match', '-fix_word_vecs_match',
              action='store_true',
              help="Fix word embeddings on the matcher side.")
...
def translate_opts(parser):
    ...
    group.add('--src_dir', '-src_dir', default="",
              help='Source directory for image or audio files')
    group.add('--qry', '-qry', required=True,
              help="Query sequence (one line per "
                   "sequence)")
    group.add('--qry_dir', '-qry_dir', default="",
              help='Query directory for image or audio files')
    group.add('--tgt', '-tgt',
