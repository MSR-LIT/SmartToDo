...
class ModelSaverBase(object):
    ...
    * `_rm_checkpoint
    ...
    def save_best(self, step):
        ...
        logger.info("Saving checkpoint %d (Best so far)" % (step))
        chkpt, chkpt_name = self._save('best',  save_model)
...
class ModelSaver(ModelSaverBase):
    ...
    def _save(self, step, model):
        ...
        logger.info("Saving checkpoint %s_step_%s.pt" % (self.base_path, step))
        checkpoint_path = '%s_step_%s.pt' % (self.base_path, step)
